<x-main>
    ...
    <!-- Main Title -->
    <x-slot:title>Live Sim Issue</x-slot:title>

    <!-- Page Pre Title -->
    <x-slot:page-pre-title>Overview</x-slot:page-pre-title>

    <!-- Page Title -->
    <x-slot:page-title>Live Sim Issue</x-slot:page-title>

    <!-- Page title actions -->
    <x-slot:button>
        <!-- [Full Button]-->
        <form action="{{ route('raw.live.sim.issue.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-sm card-table table-vcenter text-nowrap datatable">
                                ...
                                @empty
                                    <tr>
                                        <td>No live sim issue data found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="mt-3 d-flex justify-content-between align-items-center">
                        @if( $simIssues->count() > 1 )
                            ...
                            @include('reports.back.sim-issue.modals.live-sim-issue-delete-all')
                        @endif
                    </div>
                </div>
            </div>
