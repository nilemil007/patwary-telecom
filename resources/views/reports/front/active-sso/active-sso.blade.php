<x-main>
    ...
    <!-- Main Title -->
    <x-slot:title>Active SSO</x-slot:title>

    <!-- Page Pre Title -->
    <x-slot:page-pre-title>Overview</x-slot:page-pre-title>

    <!-- Page Title -->
    <x-slot:page-title>Active SSO</x-slot:page-title>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm card-table table-vcenter text-nowrap datatable">
                                ...
                                <tr>
                                    ...
                                    <th>rso</th>
                                    <th>target</th>
                                    <th>ach|company ach</th>
                                    <th>remain|company remain</th>
                                    <th>ach %|company ach %</th>
                                    <th>0,1 act count</th>
                                    <th>0,1 company act count</th>
                                    <th>গতকাল এর SSO রিপোর্ট</th>
                                    <th>পরিবর্তিত হয়েছে</th>
                                </tr>
                                </thead>
