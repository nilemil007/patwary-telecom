...
{
//    private $patwary = DdHouse::firstWhere('code','MYMVAI01')->id;
//    $modina = DdHouse::firstWhere('code','MYMVAI02')->id;
//    $sumaya = DdHouse::firstWhere('code','MYMVAI03')->id;
    ...
    public function run()
    {
        ...
        $supervisor = Supervisor::firstWhere('dd_house_id', $faijul->dd_house_id)->id;
        ...
        $supervisor = Supervisor::firstWhere('dd_house_id', $badiuzzaman->dd_house_id)->id;
        ...
        $supervisor = Supervisor::firstWhere('dd_house_id', $joynalabedin->dd_house_id)->id;
...
//
        ...
        $supervisor = Supervisor::firstWhere('dd_house_id', $jubayedmia->dd_house_id)->id;
